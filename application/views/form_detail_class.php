							...
							<aside>
								<section class="vbox">
									<header class="header bg-white b-b clearfix">
										<div class="row m-t-sm">
											<div class="col-sm-8 m-b-xs">																																	
												<a href="<?php echo base_url(); ?>index.php/c_class/insert_schedule/<?php echo $id?>" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> Create</a>
											</div>											
										</div>
									</header>
									<section class="scrollable wrapper w-f">
										<section class="panel panel-default">
											<div id="table-content" class="class-table">
												<table class="table table-striped m-b-none" >
													<thead>
														<tr>															
															<th>Day of week</th><th>Begin time</th><th>End time</th><th  width="40">Edit</th><th  width="50">Delete</th>
														</tr>
													</thead>
													<tbody>														
														<?php						
														if($schedule!="false"){
															$num = count($schedule);
															for ($i=0; $i <$num ; $i++) {																
																echo "<tr id= \"".$schedule[$i]['id']."\">";																																								
																echo "<td>".$schedule[$i]['day']."</td>";																																
																echo "<td>".$schedule[$i]['begin_time']."</td>";																
																echo "<td>".$schedule[$i]['end_time']."</td>";																
																echo "<td align=\"center\"><a href=\"".base_url()."index.php/c_class/edit_schedule/".$id."/".$schedule[$i]['id']."\" class=\"editrow\"><i class=\"fa fa-edit\"></i></a></td>";
										...
										<footer>
											<div align="right">
												<a href="<?php echo base_url();?>index.php/c_class" class="text-info">Go back to see class</a>
											</div>
										</footer>																				
									</section>																	
			...
			$(".class-table .delete").click(function(){
				if (confirm("Are you sure?")) {
					...
					$.ajax({
				      ...
				      type: "POST",
				      url: "http://localhost/notebook.com/index.php/c_class/delete_schedule",
