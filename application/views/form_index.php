...
<html lang="en" class="app">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>public/js/fullcalendar/fullcalendar.css" type="text/css" cache="false" />
		<link rel="stylesheet" href="<?php echo base_url(); ?>public/js/fullcalendar/theme.css" type="text/css" cache="false" />
	...
	<body>
		...
		<script src="<?php echo base_url(); ?>public/js/jquery.ui.touch-punch.min.js" cache="false"></script>
		<script src="<?php echo base_url(); ?>public/js/jquery-ui-1.10.3.custom.min.js" cache="false"></script>
		<script src="<?php echo base_url(); ?>public/js/fullcalendar/fullcalendar.min.js" cache="false"></script>
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#calendar').fullCalendar({
					...
					events: 'http://localhost/notebook.com/index.php/json/index',				
