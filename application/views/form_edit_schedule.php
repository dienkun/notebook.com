				...
				<section class="hbox stretch">
					...
					<section id="content">
						<section class="vbox">
							<div class="col-sm-6" >
								<br>
								<form name="myform" action="<?php echo base_url();?>index.php/c_class/edit_schedule_submit/" method="post">
									<section class="panel panel-default">
										...
										<div class="panel-body">
											<p class="text-muted">
												<a href="<?php echo base_url();?>index.php/c_class/detail_class/<?php echo $class_id?>" class="text-info">Go back</a>
											</p>
											<div class="form-group">
												<label><h4>Day <?php echo $schedule["day"];?></h4></label>
												<select name="dayofweek" class="form-control m-b">
													<?php 
													$dayofweek=array("Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday");
													for ($i=0; $i < 7; $i++) { 
														if($dayofweek[$i]==$schedule["day"])															
															echo "<option selected>".$dayofweek[$i]."</option>";
														else echo "<option>".$dayofweek[$i]."</option>";
													}
													?>													
												</select>							 																			
											</div>
											...
											<div style="display: none">
												<input name="class_id" value="<?php echo $class_id; ?>">
											</div>											

											<div style="display: none">
												<input name="schedule_id" value="<?php echo $schedule_id; ?>">
											</div>
